...
# %%
# General Metadata
eMetadata = cardiac_metadata.experimentMetadata(experiment_name='_'.join(['CL-group03_restraint_3', date.today().strftime("%b-%d-%Y")]),
                                                save=True,
                                                experimenter='JP',
                                                ...
                                                night=[19, 0, 0])
# %% Subject Metadata
subject_a = cardiac_metadata.subjectMetadata(subjectId='1186965-ChR2',
                                             var_list=['pressure', 'temperature',
                                                       'battery', 'ontime',
                                                       'activity', 'signalst',
                                                       'baro'],
                                             var_pressure_loc=0,
                                             thresholds=dict(day=dict(min=80, max=119),
...
subject_b = cardiac_metadata.subjectMetadata(subjectId='1186967-CON',
                                             var_list=['pressure', 'temperature',
                                                       'battery', 'ontime',
                                                       'activity', 'signalst',
                                                       'baro'],
...
subject_c = cardiac_metadata.subjectMetadata(subjectId='1186966-CON',
                                             var_list=['pressure', 'temperature',
                                                       ...
                                                       'baro'],
                                             var_pressure_loc=14,
                                             thresholds=dict(day=dict(min=80, max=118),  # CHANGE THIS LATER
...
subject_d = cardiac_metadata.subjectMetadata(subjectId='1186963-ChR2',
                                             var_list=['pressure', 'temperature',
                                                       'battery', 'ontime',
                                                       'activity', 'signalst',
                                                       'baro'],
                                             var_pressure_loc=21,
                                             thresholds=dict(day=dict(min=80, max=117),
                                                             night=dict(min=80, max=117)),
                                             parameter='Sys',
                                             laser_trigger='HIGH',
                                             window=6,
                                             laser=dict(stim=True,
